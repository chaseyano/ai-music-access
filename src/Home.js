    ...
    <>
      <div className="column-container">
        ...
        <div className="buttons-row" aria-label="Music technology options">
          <button id="stem-button" onClick={handleStemSplitterClick} aria-label="Learn about Stem Splitters">
          ...
          <button id="visual-button" onClick={handleMusicVisualizationClick} aria-label="Learn about AI Music Visualization">
          ...
          <button id="melody-button" onClick={handleAiComposedMelodiesClick} aria-label="Learn about AI Composed Melodies">
